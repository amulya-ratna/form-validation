...
var midNameValidation=function(){

   midNameValue=midName.value.trim(); 
   validMidName=/^[A-Za-z]+$/;
   midNameErr=document.getElementById('mid-name-err');

   if(midNameValue=="")
   {
    midNameErr.innerHTML="Middle Name is required";

   }else if(!validMidName.test(midNameValue)){
     midNameErr.innerHTML="Middle Name must be only string without white spaces";
   }else{
     midNameErr.innerHTML="";
     return true;
    
   }
}

midName.oninput=function(){
